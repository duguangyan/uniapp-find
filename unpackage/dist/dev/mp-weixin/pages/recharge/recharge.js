...
var _recharge = _interopRequireDefault(__webpack_require__(/*! ./pages/recharge/recharge.vue */ 289));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _recharge_vue_vue_type_template_id_e52ed05c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./recharge.vue?vue&type=template&id=e52ed05c&scoped=true& */ 290);
...
/* harmony import */ var _recharge_vue_vue_type_style_index_0_id_e52ed05c_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./recharge.vue?vue&type=style&index=0&id=e52ed05c&lang=scss&scoped=true& */ 294);
    ...
    _c("view", { staticClass: "recharge  cf fs30" }, [
      _c("view", { staticClass: "recharge-content" }, [
        ...
        _vm.index == 1
          ...
          : _vm._e(),
        _vm.index == 2 && _vm.first_recharge
          ? _c("view", { staticClass: "bz" }, [
              _vm._v("注:"),
              _c("text", [_vm._v("1、第一次鹿币购买须大于等于15")]),
        ...
        _vm.index == 2 && !_vm.first_recharge
          ? _c("view", { staticClass: "bz" }, [
              _vm._v("注:"),
              _c("text", [_vm._v("1、鹿币可用于支付找料及取料订单")])
            ])
          : _vm._e(),
        ...
        _c("view", { staticClass: "item-4" }, [
          _c(
            ...
            [
              ...
              _vm.index == 2
                ? _c("view", { staticClass: "flr item-4-wx" }, [
                    _vm.payIndex == 0
                      ? _c("text", {
                          staticClass:
...
var _api = _interopRequireDefault(__webpack_require__(/*! ../../utils/api.js */ 10));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  methods: {
    // 判断是否第一次充值
    apiFirstRecharge: function apiFirstRecharge() {var _this = this;
      var asset_type = this.$data.payIndex == 1 ? 'balance' : 'virtual';
      _api.default.apiFirstRecharge({
        data: { asset_type: asset_type } }).
      then(function (res) {
        if (res.code == 200 || res.code == 0) {
          if (res.data == 1) {
            _this.$data.first_recharge = true;
            _this.$data.price = 15;
          }
    ...
    // 去支付
    doPay: function doPay(e) {var _this3 = this;
      if (this.$data.first_recharge && this.$data.price < 15) {
        _util.default.errorTips("首次充值鹿币必须大于或等于15");
        return false;
      }
      ...
      if (this.$data.index == 1) {
        ...
        then(function (res) {
          console.log(res);
          if (res.code == 200 || res.code == 0) {
            if (_this3.$data.payIndex == 1) {// 余额支付
              var data = res.data.data;
              var change_amount = res.data.pay.change_amount;
              var time = res.data.pay.created_at;
              uni.navigateTo({
