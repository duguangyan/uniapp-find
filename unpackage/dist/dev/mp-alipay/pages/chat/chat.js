...
/* harmony import */ var _chat_vue_vue_type_template_id_26a3dd72_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.vue?vue&type=template&id=26a3dd72&scoped=true& */ 181);
/* harmony import */ var _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.vue?vue&type=script&lang=js& */ 183);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _chat_vue_vue_type_style_index_0_id_26a3dd72_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.vue?vue&type=style&index=0&id=26a3dd72&lang=scss&scoped=true& */ 187);
...
var _md = _interopRequireDefault(__webpack_require__(/*! ../../utils/md5.js */ 185));
var _math = _interopRequireDefault(__webpack_require__(/*! ../../utils/math.js */ 186));
...
var _default = { data: function data() {return { //文字消息
      textMsg: '', //消息列表
      scrollAnimation: false, scrollTop: 0, scrollToView: '', msgList: [], hideMsgList: [], msgImgList: [], fromUserId: 0, toUserId: 0, toAvatarPath: '', fromAvatarPath: '', userInfoId: '', toupperTop: true, currentPage: 1, nextPage: true, msgTotal: 0, //录音相关参数
      //H5不能录音
    ...
    this.userInfoId = parseInt(this.fromUserId) > parseInt(this.toUserId) ? _md.default.md5(this.toUserId + this.fromUserId) : _md.default.md5(this.fromUserId + this.toUserId);if (this.globalData.connentSocket) {// 已连接则直接获取聊天历史
      var message = { fromUserId: this.fromUserId, toUserId: this.toUserId, content: 'page', smsType: 'TEXT', sysType: 1, smsStatus: 10, smsList: false, currentPage: 1, pageSize: 15 };this.globalData.localSocket.send({ data: JSON.stringify(message) });} else {// 未连接则连接过后再获取聊天历史
      _socketIo.default.initSocket(this.fromUserId, this.toUserId);} //语音自然播放结束
    this.AUDIO.onEnded(function (res) {_this.playMsgid = null;}); //录音开始事件
    this.RECORDER.onStart(function (e) {_this.recordBegin(e);}); //录音结束事件
    this.RECORDER.onStop(function (e) {_this.recordEnd(e);});}, onShow: function onShow() {var that = this;this.globalData.callback = function (res) {if (String(res.userInfoId) == '0' || res.fromUserId == 0) {return;}if (res && res.list) {that.nextPage = res.totalPage != that.currentPage;var result = res.list;if (result.length > 0) {for (var i = 0; i < result.length; i++) {if (result[i].smsType == 'IMAGE') {result[i] = that.setPicSize(result[i]);
            }
          }
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/chat/chat.js.map