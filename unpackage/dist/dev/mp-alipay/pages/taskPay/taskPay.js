(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/taskPay/taskPay"],{
...
/* harmony import */ var _taskPay_vue_vue_type_template_id_122e613a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskPay.vue?vue&type=template&id=122e613a&scoped=true& */ 140);
/* harmony import */ var _taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskPay.vue?vue&type=script&lang=js& */ 142);
...
/* harmony import */ var _taskPay_vue_vue_type_style_index_0_id_122e613a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskPay.vue?vue&type=style&index=0&id=122e613a&lang=scss&scoped=true& */ 144);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!./taskPay.vue?vue&type=script&lang=js& */ 143);
/* harmony import */ var _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_taskPay_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//
//
var _default = { data: function data() {return { payDates: {}, // 支付数据
      isDisabled: false, isOldPayPasswordModel: false, // 旧支付密码弹窗
      Length: 6, //输入框个数  
      isFocus: true, //聚焦  
      Value: "", //输入的内容  
      ispassword: true, //是否密文显示 true为密文， false为明文。
      couponId: '', payTypeList: [{ icon: '../../static/icon/money.png', title: '鹿币' }, { icon: '../../static/icon/icon-balance.png', title: '余额' }, { icon: '../../static/icon/wx.png', title: '微信支付' }], // 新数据
      couponList: '', // 优惠券信息
      ...
      taskPayList: '', //  任务数据
      address: '', // 默认地址
      companyaddress: [{ address: '', tag: '', consignee: '', mobile: '' }], // 公司地址
      balance_amount: '', // 余额
      virtual_amount: '', // 鹿币
      payTypeCheckIndex: 0, // 默认微信支付
      task_ids: '' // 任务id
    };}, onLoad: function onLoad(options) {var payMethed = options.payMethed;if (payMethed == 1) {uni.setStorageSync('method', 0);} else {uni.setStorageSync('method', 1);}uni.setStorageSync('status', 0); // 获取用户信息 余额
    // this.getUserInfo();
    // 获取余额
    this.getUserAsset(); // 获取Storage找料取料数据
    var taskPayList = uni.getStorageSync('taskPayList');var finds = taskPayList.finds;var fetchs = taskPayList.fetchs;var task_ids = taskPayList.task_ids; // 计算合计金额
    var findsTotalPrice = 0;var fetchsTotalPrice = 0;finds.forEach(function (v) {findsTotalPrice += parseFloat(v.fee);});fetchs.forEach(function (v) {fetchsTotalPrice += parseFloat(v.fee);});this.$data.taskPayList = taskPayList;this.$data.finds = finds;this.$data.fetchs = fetchs;this.$data.task_ids = task_ids;this.$data.findsTotalPrice = findsTotalPrice;this.$data.fetchsTotalPrice = fetchsTotalPrice; // 获取默认地址
    this.getDefaultAddress(); // 获取公司地址
    this.getCompanyaddress();}, onShow: function onShow() {var _this2 = this;this.$data.isDisabled = false; // 获取取送任务编辑信息
    this.$eventHub.$on('taskPayPage', function (data) {_this2.$data.address = data.address;_this2.getServicePrice();});}, mounted: function mounted() {var _this = this;this.$eventHub.$on('giftData', function (list) {_this.$data.couponList = list;_this.$data.couponListPrice = list.value;_this.$data.couponId = list.id;});}, methods: { // 去优惠券列表
    goCoupon: function goCoupon() {var totalPrice = this.$data.findsTotalPrice + this.$data.fetchsTotalPrice;uni.navigateTo({ url: '../giftCertificate/giftCertificate?from=giftCertificate&totalPrice=' + totalPrice });}, // 收货地址
    getDefaultAddress: function getDefaultAddress() {var _this3 = this;var _this = this; // 获取默认地址
      _api.default.defaultAddress({}).then(function (res) {if (res.code == 200 || res.code == 0) {_this3.$data.address = res.data;_this.getServicePrice();}});}, // 获取超范围服务费
    getServicePrice: function getServicePrice() {var _this4 = this;_api.default.apiTaskPayment({ method: 'POST', data: { task_id: this.$data.taskPayList.task_ids, address_id: this.$data.address.id } }).then(function (res) {if (res.code == 200 || res.code == 0) {var finds = [];var fetchs = [];var taskPayList = _this4.$data.taskPayList;res.data.forEach(function (o, i) {if (o.type == 1) {taskPayList.finds.forEach(function (oo, ii) {if (o.id == oo.id) {o.address = oo.address;finds.push(o);}});} else {taskPayList.fetchs.forEach(function (oo, ii) {if (o.id == oo.id) {o.address = oo.address;fetchs.push(o);}});}}); // 计算合计金额
          var findsTotalPrice = 0;var fetchsTotalPrice = 0;finds.forEach(function (v) {findsTotalPrice += parseFloat(v.total_fee);});fetchs.forEach(function (v) {fetchsTotalPrice += parseFloat(v.total_fee);});_this4.$data.finds = finds;_this4.$data.fetchs = fetchs;_this4.$data.findsTotalPrice = findsTotalPrice;_this4.$data.fetchsTotalPrice = fetchsTotalPrice;}});}, // 获取公司地址
    getCompanyaddress: function getCompanyaddress() {var _this5 = this;_api.default.getCompanyaddress({}).then(function (res) {if (res.code == 200 || res.code == 0) {console.log('公司地址');console.log(res.data.address);_this5.$data.companyaddress = res.data;}});}, // 获取余额
    getUserAsset: function getUserAsset() {var _this6 = this;_api.default.getUserAsset({}).then(function (res) {if (res.code == 200 || res.code == 0) {_this6.$data.balance_amount = res.data.balance;_this6.$data.virtual_amount = res.data.virtual;}});}, // 去地址选择页面
    goConsigneeAddress: function goConsigneeAddress(e) {wx.navigateTo({ url: '../address/address?from=taskPayPage' });}, // 优惠券选择
    payTypeCheck: function payTypeCheck(e) {this.$data.payTypeCheckIndex = e.currentTarget.dataset.index;}, // 支付
    doPay: function doPay() {var _this7 = this; // 防止多次点击重复提交
      this.$data.isDisabled = true;var _this = this;this.$data.payDates.task_ids = this.$data.task_ids; // 获取优惠券信息
      if (this.$data.couponList != '') {this.$data.couponListPrice = Math.ceil(this.$data.couponList.value);} else {this.$data.couponListPrice = 0;}if (this.$data.address == '') {_util.default.errorTips('请添加地址');return false;
      }
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/taskPay/taskPay.js.map