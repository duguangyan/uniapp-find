...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!./find.vue?vue&type=script&lang=js& */ 102);
/* harmony import */ var _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_D_software_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_12_1_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_script_js_D_software_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_D_software_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//
//
var upload = function upload() {return __webpack_require__.e(/*! import() | components/upload */ "components/upload").then(__webpack_require__.bind(null, /*! ../../components/upload.vue */ 440));};var _default = { data: function data() {return { // imgFiles:[{    // 初始化图片内容 
      ...
      // 	pct:'finish'
      // }],
      cid: '', cname: '', isCheckTime: false, areaText: '请选择服务区域', area_id: '', // 区域ID
      interval: '', isPopup: false, // 提交任务
      findDisabled: false, // 防止重复提交
      payNum: 10, // 支付倒计时
      imgFiles: [], upLoadMaxNum: 9, checkIndex: 0, isResNotes: false, isNotes: false, // 小鹿找料须知是否显示
      findNeedKnow: '', // 小鹿找料须知富文本
      navTexts: ['按图找料', '上门取样', '寄送样品'], // 找料类型 
      companyaddress: '', // 公司地址
      address: '', // 找料地址
      finds: [{ cid: '', desc: '', address: '', checkIndex: 0, desc_img: [], files: [], areaText: '请选择服务区域', area_id: '', is_compare: false, is_limit: false, reference_price: '' }], taskEditItem: '', isTaskEditItem: false, isClock: true };}, components: { upload: upload }, onLoad: function onLoad(optiosn) {// 判断是否显示说明弹窗
    if (this.$data.taskEditItem == '') {if (uni.getStorageSync('isFindNotes') == '') {this.$data.isNotes = true;}}if (optiosn.taskEditItem) {this.$data.isNotes = false;uni.setNavigationBarTitle({ title: "修改任务" });this.$data.taskEditItem = uni.getStorageSync('findItem');var item = this.$data.taskEditItem;this.$data.finds[0].id = item.id;this.$data.finds[0].cid = item.cid;this.$data.finds[0].cname = item.cname;this.$data.finds[0].check = item.check;this.$data.finds[0].find_type = item.find_type;this.$data.finds[0].checkIndex = item.find_type - 1;this.$data.finds[0].desc = item.desc;this.$data.finds[0].address_id = item.address_id;this.$data.finds[0].address = item.address;this.$data.finds[0].area_id = item.area_id;this.$data.finds[0].is_compare = item.is_compare;this.$data.finds[0].is_limit = item.is_limit;this.$data.finds[0].reference_price = item.reference_price; // areaText:'请选择服务区域',
      // area_id:'',
      // is_compare:false,
      // is_limit:false,
      // reference_price:''
      if (item.desc_img.length > 0) {var desc_img = [];item.desc_img.forEach(function (o, i) {var imgObj = { url: o, pct: 'finish' };desc_img.push(imgObj);});this.$data.finds[0].files = desc_img;}} else {uni.setNavigationBarTitle({ title: "立即找料" });} // 获取公司地址
    this.getCompanyaddress(); // 获取默认地址
    this.getSelectedAddress(); // 获取默认区域数据第一个
    this.initArea(); // 获取说明内容
    this.getNeedKnow();}, onShow: function onShow() {var _this2 = this;this.$eventHub.$on('classifyData', function (data) {console.log('classifyData:', data);_this2.$data.isNotes = false;_this2.$data.cid = data.cid;_this2.$data.cname = data.cname;_this2.$data.finds[data.index].cid = data.cid;_this2.$data.finds[data.index].cname = data.cname;_this2.$eventHub.$off('classifyData');});this.$eventHub.$on('findPage', function (data) {console.log('findPage:', data);_this2.$data.finds[data.findIndex].address = data.address;_this2.$eventHub.$off('findPage');});}, methods: { doCompare: function doCompare(b) {if (!b) {_util.default.errorTips('请先勾选比价优选按钮');}}, // 比价优选
    checkCompare: function checkCompare(index) {this.$data.finds[index].is_compare = this.$data.finds[index].is_compare == 0 ? 1 : 0;if (this.$data.finds[index].is_compare == 0) {this.$data.finds[index].reference_price = '';}}, // 限时找料
    checkLimit: function checkLimit(index) {this.$data.finds[index].is_limit = this.$data.finds[index].is_limit == 0 ? 1 : 0;if (this.$data.finds[index].is_limit != 0) {this.$data.finds[index].checkIndex = 0;}}, // 初始化服务区域
    initArea: function initArea() {var _this3 = this;_api.default.findArea({}).then(function (res) {if (res.code == 200 || res.code == 0) {if (_this3.$data.taskEditItem == '') {_this3.$data.areaText = res.data[0].name;_this3.$data.area_id = res.data[0].id;_this3.$data.finds[0].areaText = res.data[0].name;_this3.$data.finds[0].area_id = res.data[0].id;} else {_this3.$data.area_id = _this3.$data.finds[0].area_id;res.data.forEach(function (o, i) {if (o.id == _this3.$data.finds[0].area_id) {_this3.$data.finds[0].areaText = res.data[i].name;}});}}});}, // 选择服务区域
    goAreaText: function goAreaText(index) {if (!this.$data.isClock) {return false;} else {this.$data.isClock = false;}var _this = this;_api.default.findArea({}).then(function (res) {if (res.code == 200 || res.code == 0) {var arr = res.data;var newArr = [];arr.forEach(function (o, i) {newArr.push(o.name);});uni.showActionSheet({ itemList: newArr,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _find_vue_vue_type_template_id_72883bdc_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./find.vue?vue&type=template&id=72883bdc&scoped=true& */ 99);
/* harmony import */ var _find_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./find.vue?vue&type=script&lang=js& */ 101);
...
/* harmony import */ var _find_vue_vue_type_style_index_0_id_72883bdc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./find.vue?vue&type=style&index=0&id=72883bdc&lang=scss&scoped=true& */ 103);
