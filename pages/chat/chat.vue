<template>
	<view>
		<view class="content" @touchstart="hideEmoji">
			<scroll-view class="msg-list" upper-threshold="20" scroll-y="true" :scroll-with-animation="scrollAnimation"
		...
		<view class="input-box" :class="showEmji" @touchmove.stop.prevent="discard">
			...
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					<view class="box">
						<!-- <textarea v-model="textMsg" auto-height="true" cursor-spacing="15" :show-confirm-bar="false" id="textMsg" /> -->
						<input v-model="textMsg" confirm-type="send" confirm-hold="true" cursor-spacing="15" @blur="sendBlur" @confirm="sendText" id="textMsg" />
					</view>
	...
	export default {
		...
		methods: {
			...
			sendText(e){
				...
				let messageId = new Date().getTime() + that.fromUserId + that.toUserId + math.math(5);
